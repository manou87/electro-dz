...
const IMPORTS = [
  ...
  {
    id: "grand-livre-electricite",
    collection: "francais",
    category: "formation",
    src: "/Users/a/Downloads/le grand livre de l'électricité.pdf",
    titleFr: "Le grand livre de l'électricité",
    titleAr: "الكتاب الكبير في الكهرباء",
    descriptionFr: "Ouvrage de référence — électricité générale, installations et applications.",
    descriptionAr: "مرجع شامل في الكهرباء العامة والتركيبات والتطبيقات.",
    lang: ["fr"],
    year: 0,
    featured: true,
  },
  {
    id: "mesures-essais-machines-electriques",
    collection: "francais",
    category: "energie",
    src: "/Users/a/Downloads/Mesures et essais sur machines électriques.pdf",
    titleFr: "Mesures et essais sur machines électriques",
    titleAr: "القياسات والاختبارات على الآلات الكهربائية",
    descriptionFr: "Méthodes de mesure, essais et contrôle des machines électriques.",
    descriptionAr: "طرق القياس والاختبار والفحص للآلات الكهربائية.",
    lang: ["fr"],
    year: 0,
    featured: true,
  },
  {
    id: "schemas-electriques-tome-1",
    collection: "francais",
    category: "installation",
    src: "/Users/a/Downloads/schema-electriques-1.pdf",
    titleFr: "Schémas électriques — tome 1",
    titleAr: "المخططات الكهربائية — الجزء 1",
    descriptionFr: "Lecture, symboles et réalisation de schémas électriques (volume 1).",
    descriptionAr: "قراءة ورموز وإنجاز المخططات الكهربائية (المجلد 1).",
    lang: ["fr"],
    year: 0,
  },
  {
    id: "schemas-electriques-tome-2",
    collection: "francais",
    category: "installation",
    src: "/Users/a/Downloads/schema-electriques-2.pdf",
    titleFr: "Schémas électriques — tome 2",
    titleAr: "المخططات الكهربائية — الجزء 2",
    descriptionFr: "Lecture, symboles et réalisation de schémas électriques (volume 2).",
    descriptionAr: "قراءة ورموز وإنجاز المخططات الكهربائية (المجلد 2).",
    lang: ["fr"],
    year: 0,
  },
];
