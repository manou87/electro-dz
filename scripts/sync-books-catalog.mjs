...
const ELECTRONS_BOOKS = [
  { id: "phaseurs-80", collection: "francais", category: "monophase",
    ...
    lang: ["fr", "ar"], year: 2026, pdfUrl: "https://electrons.ch/data/files/electrotech/diagrammevecteur_1770372925.pdf", featured: true },
  { id: "phaseurs-2pp", collection: "francais", category: "monophase",
    ...
    lang: ["fr"], year: 2026, pdfUrl: "https://electrons.ch/data/files/electrotech/diagrammevecteur2a5.pdf", featured: true },
  { id: "phaseurs-complexes", collection: "francais", category: "monophase",
    ...
    lang: ["fr"], year: 2026, pdfUrl: "https://electrons.ch/data/files/electrotech/diagrammevecteurcomplexe3.pdf" },
  { id: "filtres-passe", collection: "francais", category: "monophase",
    ...
    lang: ["fr"], year: 2026, pdfUrl: "https://electrons.ch/data/files/filtredupremierordrebodes2pages.pdf" },
  { id: "triphase-denom", collection: "francais", category: "triphase",
    ...
    lang: ["fr", "ar"], year: 2026, pdfUrl: "https://electrons.ch/data/files/electrotech/triphasdnominationsusuelles2x.pdf", featured: true },
  { id: "magnetisme-resume", collection: "francais", category: "magnetisme",
    ...
    lang: ["fr", "ar"], year: 2026, pdfUrl: "https://electrons.ch/data/files/electrotech/rsumdumagntisme1.pdf" },
  { id: "energie-suisse", collection: "suisse", category: "energie",
    ...
    lang: ["fr"], year: 2026, pdfUrl: "https://electrons.ch/data/files/electrotech/diagrammeenergiesuisse24a4.pdf" },
];

const EXISTING_LOCAL = [
  { id: "pdie-2018-01", collection: "suisse", category: "normes", pdf: "pdf/pdie-2018-01.pdf",
    titleFr: "PDIE 2018-01", titleAr: "وثيقة PDIE 2018-01",
    descriptionFr: "Document technique installation et protection (PDIE).", descriptionAr: "وثيقة التركيب والحماية PDIE.",
    lang: ["fr"], year: 2018, featured: true },
  { id: "fortec-formulaire-1987", collection: "francais", category: "installation", pdf: "pdf/fortec-formulaire-1987.pdf",
    ...
    lang: ["fr"], year: 1987 },
  { id: "ie-pos-5-plan-pq22", collection: "francais", category: "installation", pdf: "pdf/ie-pos-5-plan-pq22.pdf",
    ...
    lang: ["fr"], year: 2022 },
  { id: "manuel-principes-protection", collection: "francais", category: "securite", pdf: "pdf/manuel-principes-protection.pdf",
    ...
    lang: ["fr"] },
  { id: "com-katalog-22-fr", collection: "francais", category: "installation", pdf: "pdf/com-katalog-22-fr.pdf",
