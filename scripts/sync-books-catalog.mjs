...
const EXISTING_LOCAL = [
  ...
  { id: "pdie-ch-2021", collection: "suisse", category: "normes", pdf: "pdf/pdie-ch-2021.pdf",
    titleFr: "PDIE-CH 2021", titleAr: "PDIE-CH 2021 — المعيار السويسري",
    descriptionFr: "Prescriptions suisses installations BT (PDIE-CH), éd. 2021 — source officielle.",
    descriptionAr: "اشتراطات التركيبات BT في سويسرا (PDIE-CH)، 2021 — مصدر رسمي.",
