  ...
  var QUESTIONS = [
    ...
    },
    {
      ...
      opts: [
        ...
        "تزيد مقطع الكابل أو تغيّر المنحنى (مثلاً بي)، أو تقصّر / تقسّم الخط",
        "تعطّل التفاضلي",
        "تكتب صالح لأن المصباح يضيء"
      ],
      a: 1,
      why: "تكبير القاطع يرفع العتبة ويزيد المشكلة. الأولوية: زيادة المقطع أو تغيير المنحنى، ثم تقصير أو تقسيم الخط."
    },
    {
