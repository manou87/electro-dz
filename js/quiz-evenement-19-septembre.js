(function () {
  ...
  var QUESTIONS = [
    {
      q: "نظام TN — أين تقيس تيار القصر الأدنى؟",
      terms: "نظام TN · Icc min",
      opts: [
        "في رأس اللوحة فقط",
    ...
    {
      q: "نظام TN — قاطع ستة عشر أمبير منحنى سي: ما قيمة العتبة المغناطيسية التي نقارن بها القياس؟",
      terms: "نظام TN · 16 A · courbe C · 10 × In",
    ...
    {
      q: "نظام TN — على آخر مأخذ الجهاز يظهر خمسة وتسعين أمبير. كيف تقرأ النتيجة؟",
      terms: "نظام TN · Icc min = 95 A · 10 × In = 160 A",
      opts: [
    ...
    {
      q: "نظام TN — إذا كان تيار القصر الأدنى أصغر من عتبة القاطع، ماذا تفعل؟",
      terms: "نظام TN · Icc min < 10 × In",
      opts: [
    ...
    },
    {
      ...
      terms: "Riso · MΩ",
      opts: ["كيلوأوم / kΩ", "ميغاأوم / MΩ", "فولت / V", "أمبير / A"],
      a: 1,
      why: "العزل يُسجَّل بالميغاأوم (MΩ)، لا بالكيلوأوم ولا بالفولت ولا بالأمبير."
    },
    {
    ...
    },
    {
      ...
      a: 1,
      why: "تيار العطل L–PE يتحقق من مسار العطل عبر الواقي ورجوع الأرض (مهم خاصة في TT). ليس تيار قصر كالـ Icc بين الطور والمحايد."
    },
    {
    ...
    {
      q: "نظام TT — مقاومة الأرض أو حلقة الأرض تُسجَّل عادة بأي وحدة؟",
      terms: "نظام TT · Re · Ω",
    ...
    {
      q: "نظام TN — تيار القصر بين الطور والمحايد ماذا يمثّل؟",
      terms: "نظام TN · Icc L–N",
      opts: [
        "نفس قياس العزل",
      ...
      a: 1,
      why: "Icc L–N = تيار قصر طور–محايد. مسار العطل عبر الواقي يُفحص بتيار العطل L–PE، لا بنفس تسمية Icc."
    }
  ];
