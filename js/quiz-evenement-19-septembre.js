(function () {
  ...
  var QUESTIONS = [
    ...
    {
      q: "قياس تيار القصر بين الطور والأرضي ماذا يفيد أساساً؟",
      terms: "Icc L–PE",
      opts: [
        "قدرة البطارية فقط",
        "التحقق من مسار العطل عبر الموصل الواقي",
        "قياس العزل بالميغاأوم",
        "ضبط عيار التفاضلي"
      ],
      a: 1,
      why: "Icc L–PE يبيّن إن كان مسار العطل عبر الواقي كافياً لتشغيل الحماية. L–N يخصّ مسار الطور–المحايد."
    },
    {
    ...
    },
    {
      ...
      opts: [
        "نفس قياس العزل",
        "تيار العطل المحتمل بين الطور والمحايد، لا عبر الواقي",
        "زمن قطع التفاضلي",
        "مقاومة الأرض فقط"
      ],
      a: 1,
      why: "Icc L–N لمسار الطور–المحايد. للتحقق من مسار الواقي ننظر إلى Icc L–PE."
    }
  ];
